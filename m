Return-Path: <linux-rtc+bounces-4114-lists+linux-rtc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rtc@lfdr.de
Delivered-To: lists+linux-rtc@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [147.75.199.223])
	by mail.lfdr.de (Postfix) with ESMTPS id 416F1ABCCBB
	for <lists+linux-rtc@lfdr.de>; Tue, 20 May 2025 04:06:06 +0200 (CEST)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 386D54A4F4C
	for <lists+linux-rtc@lfdr.de>; Tue, 20 May 2025 02:05:47 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 641EA25A2C1;
	Tue, 20 May 2025 02:04:30 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b="IJMSEnID"
X-Original-To: linux-rtc@vger.kernel.org
Received: from mail-pl1-f179.google.com (mail-pl1-f179.google.com [209.85.214.179])
	(using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id D17C0259C84;
	Tue, 20 May 2025 02:04:27 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=209.85.214.179
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1747706670; cv=none; b=p6SXsGQTnQ4es8gVNVwVQvQ2BQZsJDu2xUfLBJoUG+jZdSt3P0MiyiHD16jtXr9nxkbDJK3K039zC/fI5/gU7uK8xpYPcepNTXvYX4sto+fz74ePy2WixDj5wRhGH3UQl1dvHqjDutGWZpigzq7Q6vM4v1o718HNG81onZsaV/o=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1747706670; c=relaxed/simple;
	bh=EJ4n3CkccFAMST51yyc5wAQoYC8brmFuTUf8pI0dGto=;
	h=From:To:Cc:Subject:Date:Message-Id:In-Reply-To:References:
	 MIME-Version; b=WlpJPyaezKwI6QiIHtACkhr9Bm4OAGBy/6j3tQvZcMZZboZAARzwglzQiW5uFnn5ADBbMpzmicOgcuq8Ih795goskeoySiSBeZ5rkI5KDxQGF066tJtuOt1HlayiRlNO/31ys/Q4KD+kYkNKtRMKBM3jbI6OtKROJAMEe1AHIaQ=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com; spf=pass smtp.mailfrom=gmail.com; dkim=pass (2048-bit key) header.d=gmail.com header.i=@gmail.com header.b=IJMSEnID; arc=none smtp.client-ip=209.85.214.179
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=gmail.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=gmail.com
Received: by mail-pl1-f179.google.com with SMTP id d9443c01a7336-231e331baceso35305815ad.0;
        Mon, 19 May 2025 19:04:27 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20230601; t=1747706667; x=1748311467; darn=vger.kernel.org;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:from:to:cc:subject:date
         :message-id:reply-to;
        bh=qF1Lw1R1zsaVCEFK0ZWlsyzF3qbtqAiS9LdW/HhJMRs=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20230601; t=1747706667; x=1748311467;
        h=content-transfer-encoding:mime-version:references:in-reply-to
         :message-id:date:subject:cc:to:from:x-gm-message-state:from:to:cc
         :subject:date:message-id:reply-to;
        bh=qF1Lw1R1zsaVCEFK0ZWlsyzF3qbtqAiS9LdW/HhJMRs=;
        b=
X-Forwarded-Encrypted: i=1; AJvYcCU+T6yQrXVfuLAYRAEUOL4bdeaQyEj/EVQ7adiMEyeyVlZlWG5DBarNsYa/k4E3QFWmcfKqn3nf5N1SAA==@vger.kernel.org, AJvYcCUFwwu1bAUYlNaJXb6NlEHoimPbB9jwd3IcYsfhh4fRwuXyHAPnL3R3VtT6fjmJucCUjp4tWy7Y@vger.kernel.org, AJvYcCUy4BgMusj5K4AnWhd7aV81TCGNeBT6PqmaXcI4sfX431xbeJNVeR0HtULIoLxC+K/ZPgsANWpEZmT+@vger.kernel.org, AJvYcCV0PvGe92rj6Brv0VCFzuJEQPRZ084i8MXEd5ekUv2HwO6GENjTPYFQcM5pRP4R+D1Kv9YL2EqlEywh@vger.kernel.org, AJvYcCW1H9SjgmIYGiIGtetT0rMZWA/5LBj/06L2VvcP2UtgDSavJRlIFRGybKqWDXV24YzU1FBZ0djHx59s@vger.kernel.org, AJvYcCWW4/kODnjfEZtCPUHwObNAluN7tEmjmoUSLlXeNilvnVGr8r+xo6HWkrjqJl3x0/qVUZDKjX4YzdI=@vger.kernel.org, AJvYcCXIEAtFgL7aRpAopmBRwYfcIJQEdv2E0QgoAfYLQFzv4Di96MEjph2jWnDFY3D0oV+LLFfzuNlr6MsgtY2rnxU=@vger.kernel.org, AJvYcCXR2i7mBW5/O5tPsBc/4AS3kGOtYVQ4d43jUT4mzYjf9Wmoztwpxc75Wr8Mf3BhfNZF30GcaDl3YG4pu3k=@vger.kernel.org
X-Gm-Message-State: AOJu0Yx+cN8FsYf6zBN9LfSr23AUaqyR3u+OEniaFV0lrZovhqLM5jaF
	s4S95cyQAmaV0jD2YHPdf4U+miwoetrj9SzMBzx1vUg85ZJ3Q1Zut+79
X-Gm-Gg: 
X-Google-Smtp-Source: AGHT+IHHAjFXv37L/ARAwn/a3QIdgJfXE44ZrW/calAEQSEkU+rCeJwPIZU0juztNGgQXxN0SNAI0w==
X-Received: by 2002:a17:902:d4c5:b0:231:f5a8:174d with SMTP id d9443c01a7336-231f5a81c2bmr198565635ad.44.1747706666809;
        Mon, 19 May 2025 19:04:26 -0700 (PDT)
Received: from hcdev-d520mt2.. (60-250-196-139.hinet-ip.hinet.net. [60.250.196.139])
        by smtp.gmail.com with ESMTPSA id d9443c01a7336-231d4ac9fc8sm66543855ad.27.2025.05.19.19.04.23
...
Subject: [PATCH v11 4/7] can: Add Nuvoton NCT6694 CANFD support
Date: Tue, 20 May 2025 10:03:52 +0800
Message-Id: <20250520020355.3885597-5-tmyu0@nuvoton.com>
...
index 88a6be6b05a8..57b95c21a626 100644
--- a/MAINTAINERS
+++ b/MAINTAINERS
@@ -17457,6 +17457,7 @@ S:	Supported
...
index 000000000000..1ebf78391287
--- /dev/null
...
+};
+
+static DEFINE_IDA(nct6694_canfd_ida);
+
...
+
+	/* Enable Transmitter Delay Compensation (TDC) only if the Data Bit Rate
+	 * Prescaler (DBRP) is within the allowed range for TDC.
+	 *
+	 * Per hardware requirements, TDC must be disabled when DBRP > 1.
+	 */
+	if (d_bt->brp <= 2)
...
+
+	port = ida_alloc(&nct6694_canfd_ida, GFP_KERNEL);
+	if (port < 0)
+		return port;
+
+	irq = irq_create_mapping(nct6694->domain, NCT6694_IRQ_CAN0 + port);
+	if (!irq) {
+		ret = -EINVAL;
+		goto free_ida;
+	}
...
+free_ida:
+	ida_free(&nct6694_canfd_ida, port);
+	return ret;
+}
+
