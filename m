...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id E7D95109176
	for <lists+linux-rtc@lfdr.de>; Mon, 25 Nov 2019 17:01:06 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728732AbfKYQBD (ORCPT <rfc822;lists+linux-rtc@lfdr.de>);
        Mon, 25 Nov 2019 11:01:03 -0500
Received: from bhuna.collabora.co.uk ([46.235.227.227]:59966 "EHLO
        bhuna.collabora.co.uk" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1728454AbfKYQBC (ORCPT
        <rfc822;linux-rtc@vger.kernel.org>); Mon, 25 Nov 2019 11:01:02 -0500
Received: from [127.0.0.1] (localhost [127.0.0.1])
        (Authenticated sender: eballetbo)
        with ESMTPSA id 62FED28F5FD
...
Message-ID: <9187f97e-7100-8a45-22c8-e58a5900a930@collabora.com>
Date:   Mon, 25 Nov 2019 17:00:53 +0100
...
On 22/11/19 0:45, Raul E Rangel wrote:
> It's very confusing having cros_ec_dev and cros_ec_device. This makes it
> clear you are dealing with the mfd device.
> 

To be honest I also get confused, always. A change like this, was in my TODO
list for long time, but never really worked on it, so many thanks to send this
patch. Said that, I agree with Lee Jones regarding use _mfd_ in the name.

In my mind, though, I always thought to rename the `struct cros_ec_device` to
`struct cros_ec`. For me cros_ec_dev in MFD makes sense because is the one that
instantiates the sub-devices.

I'd be also nice, "fix" the random name of some local variables (ec vs ec_dev vs
ec_device, pointing indeferently to cros_ec_dev and cros_ec_device structs)

This is really stetic, IMHO helps to understand better the code, but as is a
massive change, I'd like to hear the Guenter, Benson and Gwendal opinions here.
