Return-Path: <linux-rtc+bounces-5478-lists+linux-rtc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rtc@lfdr.de
Delivered-To: lists+linux-rtc@lfdr.de
Received: from sv.mirrors.kernel.org (sv.mirrors.kernel.org [IPv6:2604:1380:45e3:2400::1])
	by mail.lfdr.de (Postfix) with ESMTPS id 5D327C8E00E
	for <lists+linux-rtc@lfdr.de>; Thu, 27 Nov 2025 12:22:27 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by sv.mirrors.kernel.org (Postfix) with ESMTPS id 388923B6EBF
	for <lists+linux-rtc@lfdr.de>; Thu, 27 Nov 2025 11:19:33 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1ED9A32C33D;
	Thu, 27 Nov 2025 11:19:16 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b="Gmu5kFQp"
X-Original-To: linux-rtc@vger.kernel.org
Received: from out-184.mta0.migadu.com (out-184.mta0.migadu.com [91.218.175.184])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 597212FB997
	for <linux-rtc@vger.kernel.org>; Thu, 27 Nov 2025 11:19:12 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=91.218.175.184
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1764242356; cv=none; b=igMDQwS+i3LoNYTosC1fhH8CgGDlyyzGimW31VLHOIt+aB4H4BuN8mBbAo8VzX/WvS76mCLZa+nVNRfSGtmSWsl/XCTNQRkAxRMDuHsekwSVOJDk7qoNZmriblghnOfn1d1fvibzFA35tKNcvpZIyCbtemGS5vF3kHjKszno12Q=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1764242356; c=relaxed/simple;
	bh=Vi2aUlK2kPHePuQQ4FdVhjAIDP5JOYO55eFn6JXO9y4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=OGMgrtb3Ia8c1i2BPUVD9u81cHD2Ax3ysESdiKYPmlJ3qQs67iBAa7ko35jvaj9vwxC+L5J+IHcHO7oi1effLeG1JhmwlHDR9CJm0Pv5LEue7iB6xUkl2sfz8fvCNUGrjadBs0+0qqDDVm30o66bCUV0JpmuGQQFMt+lJ05hs8U=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev; spf=pass smtp.mailfrom=linux.dev; dkim=pass (1024-bit key) header.d=linux.dev header.i=@linux.dev header.b=Gmu5kFQp; arc=none smtp.client-ip=91.218.175.184
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=linux.dev
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=linux.dev
Date: Thu, 27 Nov 2025 13:19:03 +0200
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=linux.dev; s=key1;
	t=1764242350; h=from:from:reply-to:reply-to:subject:subject:date:date:
	 message-id:message-id:to:to:cc:cc:mime-version:mime-version:
	 content-type:content-type:in-reply-to:in-reply-to:  references:references;
	bh=W9li3U+CnzyQuYWOtITEQYngDBOeulac8ZFnfj0m3XE=;
	b=Gmu5kFQpRfyIqatwuLiWX4x09TYrh3FTozeyjWTguBrOn3To7K3KAWs/tt0nWddH/XlXRK
	jmEp1BKloNjyYtfDWUWB3QCblrb4F+muTNAMpj0l/w+UDrVIJpRVCQfEgMu+80AAK/ENlb
	hGT5Y0ciJavYiQGwrgrN4IpS8gJbWas=
...
Subject: [PATCH v6 09/17] mfd: rohm-bd71828: Support ROHM BD72720
Message-ID: <cc381b1bfb736312b39880eaa7328c71f38d6980.1764241265.git.mazziesaccount@gmail.com>
...
Content-Type: multipart/signed; micalg=pgp-sha512;
	protocol="application/pgp-signature"; boundary="tXgq9j1fbuDH8MvD"
...
Revision history:
 v5 =3D> v6:
 - Plenty of styling fixes as suggested by Lee
 - Add a define for the register offset 0x100
 - use ERR_CAST()
...
---
 ...
 drivers/mfd/rohm-bd71828.c       | 490 +++++++++++++++++++++++-
 include/linux/mfd/rohm-bd72720.h | 634 +++++++++++++++++++++++++++++++
 include/linux/mfd/rohm-generic.h |   1 +
 4 files changed, 1129 insertions(+), 14 deletions(-)
 create mode 100644 include/linux/mfd/rohm-bd72720.h

diff --git a/drivers/mfd/Kconfig b/drivers/mfd/Kconfig
index 6cec1858947b..80c5d1753908 100644
...
index 218945a8ec94..e54152a03510 100644
...
+
 static struct gpio_keys_button button =3D {
 	.code =3D KEY_POWER,
 	.gpio =3D -1,
@@ -44,6 +61,12 @@ static const struct resource bd71828_rtc_irqs[] =3D {
...
@@ -157,6 +180,74 @@ static struct mfd_cell bd71828_mfd_cells[] =3D {
 	},
 };
=20
...
@@ -181,6 +272,91 @@ static const struct regmap_range bd71828_volatile_rang=
es[] =3D {
...
@@ -191,6 +367,21 @@ static const struct regmap_access_table bd71828_volati=
le_regs =3D {
...
+
 static const struct regmap_config bd71815_regmap =3D {
 	.reg_bits =3D 8,
 	.val_bits =3D 8,
@@ -207,10 +398,79 @@ static const struct regmap_config bd71828_regmap =3D {
...
@@ -222,6 +482,15 @@ static unsigned int bit5_offsets[] =3D {3};		/* VSYS I=
RQ */
...
@@ -233,6 +502,17 @@ static const struct regmap_irq_sub_irq_map bd718xx_sub=
_irq_offsets[] =3D {
...
@@ -406,6 +686,117 @@ static const struct regmap_irq bd71828_irqs[] =3D {
...
@@ -438,6 +829,28 @@ static const struct regmap_irq_chip bd71815_irq_chip =
=3D {
 	.irq_reg_stride =3D 1,
 };
=20
+static const unsigned int bd72720_irq_type_base[] =3D { BD72720_REG_GPIO1_=
CTRL };
+
...
+
 static int set_clk_mode(struct device *dev, struct regmap *regmap,
 			int clkmode_reg)
 {
@@ -484,11 +897,39 @@ static void bd71828_remove_poweroff(void *data)
...
+		dev_err_probe(&i2c->dev, PTR_ERR(secondary_i2c), "Failed to get secondar=
y I2C\n");
+
...
@@ -496,6 +937,7 @@ static int bd71828_i2c_probe(struct i2c_client *i2c)
 	int cells;
 	int button_irq;
 	int clkmode_reg;
...
@@ -527,15 +969,34 @@ static int bd71828_i2c_probe(struct i2c_client *i2c)
 		 */
 		button_irq =3D 0;
 		break;
...
@@ -546,6 +1007,20 @@ static int bd71828_i2c_probe(struct i2c_client *i2c)
...
+	}
 	if (button_irq) {
 		...
 		if (ret < 0)
@@ -587,6 +1062,9 @@ static const struct of_device_id bd71828_of_match[] =
=3D {
 	}, {
...

=KkC0
-----END PGP SIGNATURE-----
