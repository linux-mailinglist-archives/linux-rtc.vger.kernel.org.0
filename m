...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 56B144893ED
	for <lists+linux-rtc@lfdr.de>; Mon, 10 Jan 2022 09:46:08 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S242581AbiAJIps (ORCPT <rfc822;lists+linux-rtc@lfdr.de>);
        Mon, 10 Jan 2022 03:45:48 -0500
Received: from mout.kundenserver.de ([217.72.192.73]:48423 "EHLO
        mout.kundenserver.de" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S241176AbiAJImy (ORCPT
        <rfc822;linux-rtc@vger.kernel.org>); Mon, 10 Jan 2022 03:42:54 -0500
Received: from quad ([82.142.23.158]) by mrelayeu.kundenserver.de (mreue107
 [212.227.15.183]) with ESMTPSA (Nemesis) id 1MQuLB-1ml2QP2wAJ-00Nve3; Mon, 10
 Jan 2022 09:42:43 +0100
...
Subject: [PATCH v3 2/2] m68k: introduce a virtual m68k machine
Date:   Mon, 10 Jan 2022 09:42:39 +0100
Message-Id: <20220110084239.1597511-3-laurent@vivier.eu>
X-Mailer: git-send-email 2.33.1
In-Reply-To: <20220110084239.1597511-1-laurent@vivier.eu>
References: <20220110084239.1597511-1-laurent@vivier.eu>
MIME-Version: 1.0
Content-Transfer-Encoding: 8bit
X-Provags-ID: V03:K1:+37F6W9iCot6ugmjD8MaGVmrypx12Vu+S/cRRw0QDcndMVQxFVx
 q6tcgkBU2bsocV6fgyp6mOkW8jMB4tkPDKiLdqghOd/T5gasIGKoCc53HbBWXp374LBx6cw
 wI1OkC5H0iaIm6HrcyJFtabOt6kH8qtffijqAEYDOeXXlYVxiqoPoYcga7eo1mKsqROVQyn
 tuccd8SsEvOuP70JtdBTw==
X-Spam-Flag: NO
X-UI-Out-Filterresults: notjunk:1;V03:K0:Sx+ougvfP8M=:1Nn73XnwPXtZIMWnR5E2SU
 
Precedence: bulk
...
index cdbf8aec7d27..b35b6109a4e0 100644
--- a/arch/m68k/include/asm/config.h
+++ b/arch/m68k/include/asm/config.h
@@ -17,6 +17,7 @@ extern int mvme16x_parse_bootinfo(const struct bi_record *);
...
new file mode 100644
index 000000000000..3b1ac40c77bc
--- /dev/null
