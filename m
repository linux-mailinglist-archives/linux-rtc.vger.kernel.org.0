Return-Path: <linux-rtc+bounces-3602-lists+linux-rtc=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-rtc@lfdr.de
Delivered-To: lists+linux-rtc@lfdr.de
Received: from ny.mirrors.kernel.org (ny.mirrors.kernel.org [IPv6:2604:1380:45d1:ec00::1])
	by mail.lfdr.de (Postfix) with ESMTPS id C9143A6D362
	for <lists+linux-rtc@lfdr.de>; Mon, 24 Mar 2025 04:54:30 +0100 (CET)
Received: from smtp.subspace.kernel.org (relay.kernel.org [52.25.139.140])
	(using TLSv1.2 with cipher ECDHE-ECDSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by ny.mirrors.kernel.org (Postfix) with ESMTPS id 3405A167C4A
	for <lists+linux-rtc@lfdr.de>; Mon, 24 Mar 2025 03:54:29 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 0B971186287;
	Mon, 24 Mar 2025 03:54:20 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b="fdD4n6V1"
X-Original-To: linux-rtc@vger.kernel.org
Received: from mgamail.intel.com (mgamail.intel.com [192.198.163.17])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id BB8E42746A;
	Mon, 24 Mar 2025 03:54:05 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=192.198.163.17
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1742788459; cv=none; b=CTOMVfDjr1gTdRIJap5NI9VsUx+7r2BKmTCXrS/QqQoKB6ZtDs3v7VNSNxeOIp8fJ5S2n1yA6xnrILpNwFf3NH9M1jC/QwkpN0VIJGd07NhqGErk0s8HdlnDMalv8nW7zBZIIjO42iPzjhbVyE8rreGezbh5OB1QssyObLdRnkk=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1742788459; c=relaxed/simple;
	bh=xyhrPvMzjFJUneRDm/eJzwlYKhaiaA5iGaa4OIiEeW4=;
	h=Date:From:To:Cc:Subject:Message-ID:References:MIME-Version:
	 Content-Type:Content-Disposition:In-Reply-To; b=MstAQct/mqMlj9FdDddpE6BxqgJM6Mz5aaR4mSG8G2UTCgtzKrL5CIb2OpTC2kC13ipX1rz9Xo48m69ksIVTPOj2wIOPhUZtV/D8LTAbCE8aI1M1PoAzQssXnppIT9FL+AjDjKbN312//5yOsgdmUf66N8Pzq4lJ9nP0aDw7a+A=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com; spf=pass smtp.mailfrom=intel.com; dkim=pass (2048-bit key) header.d=intel.com header.i=@intel.com header.b=fdD4n6V1; arc=none smtp.client-ip=192.198.163.17
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=intel.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=intel.com
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple;
  d=intel.com; i=@intel.com; q=dns/txt; s=Intel;
  t=1742788446; x=1774324446;
  h=date:from:to:cc:subject:message-id:references:
   mime-version:content-transfer-encoding:in-reply-to;
  bh=xyhrPvMzjFJUneRDm/eJzwlYKhaiaA5iGaa4OIiEeW4=;
  b=fdD4n6V1bJczDGkGFLorJeWm5fxGtD+ybdtnZZ3IIvo4SZDYvm6/vaZ3
   uys7d+4Iu8pZGw/n6hWJ5cltT//xwLTZY0FkhYssd3vctXqXPy2OtbY7g
   n8YAizqmHWhRhcUAOLAfZhTaD0MWHmUePVHqbwTyOySUpv/KQNQA7khxz
   90bK4sR8e88UdW3wyF5k3PGkChPF+zc053igNVJTLcvWHrif0VWJVVIe2
   wgYIsavFPIhU1PsVw/lvPNKzOAlh+mo51//hhACShz0+64ngA2qMwA7f5
   rUSsWra939OuP77aRtCldhF/gI/oy81A0iopj+Q9T5QuH/w98Sgxgigp5
   Q==;
X-CSE-ConnectionGUID: zj5bfvDrR3+OaiTM/lO8rg==
X-CSE-MsgGUID: BivnI/hCTc2cxEiJ4HZilw==
X-IronPort-AV: E=McAfee;i="6700,10204,11382"; a="43851848"
X-IronPort-AV: E=Sophos;i="6.14,271,1736841600"; 
   d="scan'208";a="43851848"
Received: from orviesa004.jf.intel.com ([10.64.159.144])
  by fmvoesa111.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 23 Mar 2025 20:54:02 -0700
X-CSE-ConnectionGUID: rsA57E3PSpCzpaj8GOkJiw==
X-CSE-MsgGUID: NtiJWuBEQtGcnqNZdFbO6Q==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="6.14,271,1736841600"; 
   d="scan'208";a="128979075"
Received: from lkp-server02.sh.intel.com (HELO e98e3655d6d2) ([10.239.97.151])
  by orviesa004.jf.intel.com with ESMTP; 23 Mar 2025 20:53:54 -0700
Received: from kbuild by e98e3655d6d2 with local (Exim 4.96)
	(envelope-from <lkp@intel.com>)
	id 1twYrU-0003Dc-2a;
	Mon, 24 Mar 2025 03:53:27 +0000
...
MIME-Version: 1.0
Content-Type: multipart/mixed; boundary="RSeMnbOU8Xm72Evn"
...
reproduce (this is a W=1 build):
        ...
        git checkout c4d4884b67802c41fd67399747165d65c770621a
        b4 shazam https://lore.kernel.org/r/20250323-s2mpg10-v1-20-d08943702707@linaro.org
        ...
        COMPILER_INSTALL_PATH=$HOME/0day COMPILER=clang-20 ~/lkp-tests/kbuild/make.cross W=1 O=build_dir ARCH=x86_64 SHELL=/bin/bash drivers/mfd/
...
#
CONFIG_CC_VERSION_TEXT="clang version 20.1.1 (git://gitmirror/llvm_project 424c2d9b7e4de40d0804dd374721e6411c27d1d1)"
CONFIG_GCC_VERSION=0
CONFIG_CC_IS_CLANG=y
CONFIG_CLANG_VERSION=200101
CONFIG_AS_IS_LLVM=y
CONFIG_AS_VERSION=200101
CONFIG_LD_VERSION=0
CONFIG_LD_IS_LLD=y
CONFIG_LLD_VERSION=200101
...
CONFIG_RTW88_88XXA=y
CONFIG_RTW88_8821A=y
CONFIG_RTW88_8812A=y
...
CONFIG_BATTERY_LENOVO_YOGA_C630=y
...
CONFIG_SENSORS_SURFACE_FAN=y
CONFIG_SENSORS_SURFACE_TEMP=y
...
CONFIG_BD96801_WATCHDOG=y
CONFIG_CROS_EC_WATCHDOG=y
...
CONFIG_USB_EXTRON_DA_HD_4K_PLUS_CEC=y
...
CONFIG_VIDEO_SYNOPSYS_HDMIRX=y
...
CONFIG_DRM_IMX_LEGACY_BRIDGE=y
...
CONFIG_SND_AMD_ASOC_ACP70=y
CONFIG_SND_SOC_AMD_MACH_COMMON=y
CONFIG_SND_SOC_AMD_LEGACY_MACH=y
CONFIG_SND_SOC_AMD_SOF_MACH=y
CONFIG_SND_SOC_AMD_SDW_MACH_COMMON=y
CONFIG_SND_SOC_AMD_SOF_SDW_MACH=y
CONFIG_SND_SOC_AMD_LEGACY_SDW_MACH=y
...
CONFIG_SND_SOC_AMD_SOUNDWIRE=y
...
CONFIG_SND_SOC_LOONGSON_I2S_PLATFORM=y
...
CONFIG_SND_SOC_INTEL_AVS_MACH_ES8336=y
...
CONFIG_SND_SOC_INTEL_AVS_MACH_PCM3168A=y
...
CONFIG_SND_SOC_INTEL_SOF_NUVOTON_COMMON=y
...
CONFIG_SND_SOC_SOF_DEBUG_IPC_KERNEL_INJECTOR=y
...
CONFIG_SND_SOC_SOF_AMD_VANGOGH=y
CONFIG_SND_SOC_SOF_AMD_REMBRANDT=y
CONFIG_SND_SOC_SOF_ACP_PROBES=y
CONFIG_SND_SOC_SOF_AMD_SOUNDWIRE_LINK_BASELINE=y
CONFIG_SND_SOC_SOF_AMD_SOUNDWIRE=y
CONFIG_SND_SOC_SOF_AMD_ACP63=y
CONFIG_SND_SOC_SOF_AMD_ACP70=y
CONFIG_SND_SOC_SOF_IMX_TOPLEVEL=y
CONFIG_SND_SOC_SOF_IMX_COMMON=y
CONFIG_SND_SOC_SOF_IMX8=y
CONFIG_SND_SOC_SOF_IMX9=y
...
CONFIG_INTEL_QUICKSPI=y
CONFIG_INTEL_QUICKI2C=y
...
CONFIG_CROS_EC_UCSI=y
CONFIG_UCSI_LENOVO_YOGA_C630=y
...
CONFIG_CRYPTO_DEV_IAA_CRYPTO=y
...
#
CONFIG_KUNIT=y
CONFIG_KUNIT_SUPPRESS_BACKTRACE=y
...
CONFIG_BLACKHOLE_DEV_KUNIT_TEST=y
