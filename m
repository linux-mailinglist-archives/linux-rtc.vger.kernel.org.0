...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id CCB3152286A
	for <lists+linux-rtc@lfdr.de>; Wed, 11 May 2022 02:26:33 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S239375AbiEKA0b (ORCPT <rfc822;lists+linux-rtc@lfdr.de>);
        Tue, 10 May 2022 20:26:31 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:43352 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S239253AbiEKA01 (ORCPT
        <rfc822;linux-rtc@vger.kernel.org>); Tue, 10 May 2022 20:26:27 -0400
Received: from lelv0143.ext.ti.com (lelv0143.ext.ti.com [198.47.23.248])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id C5B2F5C86A;
        Tue, 10 May 2022 17:26:24 -0700 (PDT)
Received: from fllv0034.itg.ti.com ([10.64.40.246])
        by lelv0143.ext.ti.com (8.15.2/8.15.2) with ESMTP id 24B0Q16U060152;
        Tue, 10 May 2022 19:26:01 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=ti.com;
        s=ti-com-17Q1; t=1652228761;
        bh=5qZvucU6Dlw+ScdG3mh0pQZITKoftZjIznZTzERZBJ0=;
        h=From:To:CC:Subject:Date:In-Reply-To:References;
        b=JbFWxpDQFpoiFo3x2q2RRZe2SDOq2SXLUWYDdg6HEj96ZbqnnTlWBlezELnZCkI7d
         3TBPtzO8GHdnkNxdoFTHHi6u72HK833ov4R6onaZHwEtFLVdG1UlNfj7PQWhnbExm5
         58B9Beubnu3NAFWeyGLKFEjgF2Z2m3u8Qs/2PYDc=
Received: from DFLE111.ent.ti.com (dfle111.ent.ti.com [10.64.6.32])
        by fllv0034.itg.ti.com (8.15.2/8.15.2) with ESMTPS id 24B0Q1UQ078481
...
Received: from localhost (ileax41-snat.itg.ti.com [10.172.224.153])
        by lelv0326.itg.ti.com (8.15.2/8.15.2) with ESMTP id 24B0Q1aE028300;
        Tue, 10 May 2022 19:26:01 -0500
...
Subject: [PATCH V2 2/2] rtc: Introduce ti-k3-rtc
Date:   Tue, 10 May 2022 19:25:59 -0500
Message-ID: <20220511002600.27964-3-nm@ti.com>
...
(Vignesh's comments):
* poll_timeouts now in use.
* Dropped un-necessary prints around fence just before returning
* __maybe_unused for suspend/resume handlers
* Fixed up extra tab.
(Alexandre's comments):
* Reduced the verbosity of error messages to what is probably necessary
  to debug at field.

(other changes):
* Rebased to next-20220509, so updated Makefile to maintain alphabetical
  order.
...
index 000000000000..4b56df356264
--- /dev/null
