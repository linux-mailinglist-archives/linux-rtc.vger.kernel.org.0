Return-Path: <linux-rtc+bounces-5960-lists+linux-rtc=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-rtc@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id qEcuAOJTi2kMUAAAu9opvQ
	(envelope-from <linux-rtc+bounces-5960-lists+linux-rtc=lfdr.de@vger.kernel.org>)
	for <lists+linux-rtc@lfdr.de>; Tue, 10 Feb 2026 16:50:58 +0100
X-Original-To: lists+linux-rtc@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id B347611CBBA
	for <lists+linux-rtc@lfdr.de>; Tue, 10 Feb 2026 16:50:57 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id D00D43013707
	for <lists+linux-rtc@lfdr.de>; Tue, 10 Feb 2026 15:50:54 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id D8F6D36F403;
...
X-Spamd-Result: default: False [-1.46 / 15.00];
	...
	FROM_NEQ_ENVFROM(0.00)[tsbogend@alpha.franken.de,linux-rtc@vger.kernel.org];
	FORGED_RECIPIENTS_MAILLIST(0.00)[];
	RCVD_COUNT_FIVE(0.00)[5];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-5960-lists,linux-rtc=lfdr.de];
	DMARC_NA(0.00)[franken.de];
	DBL_BLOCKED_OPENRESOLVER(0.00)[alpha.franken.de:mid,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns]
X-Rspamd-Queue-Id: B347611CBBA
