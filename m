...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 85B544B2E85
	for <lists+linux-rtc@lfdr.de>; Fri, 11 Feb 2022 21:37:29 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1353292AbiBKUgD (ORCPT <rfc822;lists+linux-rtc@lfdr.de>);
        Fri, 11 Feb 2022 15:36:03 -0500
Received: from mxb-00190b01.gslb.pphosted.com ([23.128.96.19]:35376 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1353283AbiBKUf6 (ORCPT
        <rfc822;linux-rtc@vger.kernel.org>); Fri, 11 Feb 2022 15:35:58 -0500
Received: from mail.hugovil.com (mail.hugovil.com [162.243.120.170])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 4EEF7CE7;
        Fri, 11 Feb 2022 12:35:56 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=hugovil.com
        ...
        bh=LDgI3NKyR0PW8j6XTLsS22/qvHpHAXh0SRJ/GdUUxNk=; b=W9I+fBF1GWZ2ZuLLE/sOveYcfp
        5Tj9FPm1HT14h8X7dhgaH6jPbmGIDxqgOtxPkKZ03SYhiTFaippz169sfzYg0TzPlVlKxFYWXTtZK
        Ixcvr2lbu9ko6Vhsril0qm+yWZOXoZXPy/7Vgv1ZG30aEs+aLdCL/HRa+HO5JaDKxInQ=;
Received: from modemcable168.174-80-70.mc.videotron.ca ([70.80.174.168]:55274 helo=pettiford.lan)
        by mail.hugovil.com with esmtpa (Exim 4.92)
        (envelope-from <hugo@hugovil.com>)
        id 1nIcdz-0005vF-VM; Fri, 11 Feb 2022 15:35:53 -0500
From:   Hugo Villeneuve <hugo@hugovil.com>
To:     hvilleneuve@dimonoff.com, a.zummo@towertech.it,
        alexandre.belloni@bootlin.com
Cc:     hugo@hugovil.com, linux-rtc@vger.kernel.org,
        linux-kernel@vger.kernel.org
Date:   Fri, 11 Feb 2022 15:35:13 -0500
Message-Id: <20220211203520.3902374-8-hugo@hugovil.com>
...
Subject: [PATCH 07/14] rtc: pcf2127: add support for PCF2131 RTC
...
index 841b928e1415..a52af7465d69 100644
...
+	},
 ...
 /*
@@ -921,7 +1110,7 @@ static int pcf2127_probe(struct device *dev, struct regmap *regmap,
...
+	 * For pca2129, pcf2129 and pcf2131, only bit[7] is for Symbol WD_CD
 	 ...
 	 * logic 0.
@@ -981,6 +1170,7 @@ static const struct of_device_id pcf2127_of_match[] = {
...
@@ -1110,6 +1300,7 @@ static const struct i2c_device_id pcf2127_i2c_id[] = {
 	{ "pcf2127", PCF2127 },
 	{ "pcf2129", PCF2129 },
 	{ "pca2129", PCF2129 },
+	{ "pcf2131", PCF2131 },
...
@@ -1192,6 +1383,7 @@ static const struct spi_device_id pcf2127_spi_id[] = {
 	{ "pcf2127", PCF2127 },
 	{ "pcf2129", PCF2129 },
 	{ "pca2129", PCF2129 },
+	{ "pcf2131", PCF2131 },
...
@@ -1256,5 +1448,5 @@ static void __exit pcf2127_exit(void)
