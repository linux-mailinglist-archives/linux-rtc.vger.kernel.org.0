...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id BE56312CE8D
	for <lists+linux-rtc@lfdr.de>; Mon, 30 Dec 2019 10:45:18 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727356AbfL3JpO (ORCPT <rfc822;lists+linux-rtc@lfdr.de>);
        Mon, 30 Dec 2019 04:45:14 -0500
Received: from mail-lf1-f65.google.com ([209.85.167.65]:40533 "EHLO
        mail-lf1-f65.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727243AbfL3JpN (ORCPT
        <rfc822;linux-rtc@vger.kernel.org>); Mon, 30 Dec 2019 04:45:13 -0500
Received: by mail-lf1-f65.google.com with SMTP id i23so24800704lfo.7;
        Mon, 30 Dec 2019 01:45:09 -0800 (PST)
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=1e100.net; s=20161025;
        h=x-gm-message-state:date:from:to:cc:subject:message-id:references
         :mime-version:content-disposition:in-reply-to:user-agent;
        bh=LFo8zUD5el+NxEp5lPOVOdvhG12gQZ3XNi7Gz+TIHes=;
        b=
X-Gm-Message-State: APjAAAVEP0DJsyTCI95jBAx597gOZ9LsnGrqPF/6rnvE3tRtIHM0vhmv
        +dVv9mwcv/8oqospXcNcBcI=
X-Google-Smtp-Source: APXvYqwZyUS+mRPOmd3HP3Jx/kbKXgFhloVDpXBhvSIM/2wVSci++Pl9SPSRiPx2qKWg18GSfaw5/w==
X-Received: by 2002:ac2:53bb:: with SMTP id j27mr27417384lfh.39.1577699108488;
        Mon, 30 Dec 2019 01:45:08 -0800 (PST)
Received: from localhost.localdomain ([213.255.186.46])
        by smtp.gmail.com with ESMTPSA id i16sm18318125lfo.87.2019.12.30.01.45.06
        (version=TLS1_3 cipher=TLS_AES_256_GCM_SHA384 bits=256/256);
        Mon, 30 Dec 2019 01:45:07 -0800 (PST)
Date:   Mon, 30 Dec 2019 11:45:00 +0200
...
Subject: [PATCH v8 11/12] leds: Add common LED binding parsing support to LED
 class/core
Message-ID: <f09da87a58e64770e38c5d764985d476277cccca.1577694311.git.matti.vaittinen@fi.rohmeurope.com>
...
Changes since v7:
  - Fixed plenty of typos and the commit message contents
  - renamed node lookup function from _find_ to _get_ as it increases
    refcount
  - use max_brightness instead of LED_FULL when it is given
  - clear fwnode_owned flag upon exit
  - don't do linuxdoc out of regular comment
